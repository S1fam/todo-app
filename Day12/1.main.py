# Day11: we used custom functions to remove redundancy of the code (avoid repetetive code)
# Day12: we add arguments to our functions to optimize code even further

def get_todos(filepath):  # parameter is filepath
...
while True:
    ...
    if user_action.startswith('add'):  # if the 'add' is first in the inputed string
        ...
        write_todos(filepath='../files/todos.txt', todos_argument=todos)  # just to show how arguments work
