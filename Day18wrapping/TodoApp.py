...
directory = "C:/JerxyhoProgramFiles"
os.makedirs(directory, exist_ok=True)

if not os.path.exists("C:/JerxyhoProgramFiles/todos.txt"):
    with open("C:/JerxyhoProgramFiles/todos.txt", "w") as file:
        pass
...
list_box = Gui.Listbox(tooltip="List of todos", values=functions.get_todos("C:/JerxyhoProgramFiles/todos.txt"),
...
while True:
    ...
    match button_pressed:
        case "Add":
            todos = functions.get_todos("C:/JerxyhoProgramFiles/todos.txt")
            new_todo = values['enter_todo'] + '\n'
            todos.append(new_todo)
            functions.write_todos(todos, "C:/JerxyhoProgramFiles/todos.txt")
