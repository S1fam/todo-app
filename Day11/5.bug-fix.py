# 1. The following get_maximum function is designed to return the maximum value of the Celsius list,
...
fahrenheit = celsius * 1.8 + 32
print(f"Temperature in celsius: {celsius} is equal to {fahrenheit} fahrenheit")
