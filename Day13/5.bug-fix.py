# 1. The following formula calculates the free-fall time of an object: t = sqrt(2h/g)
...
# the free-fall distance h and the gravity g which will be a default parameter with a value of 9.80665:
