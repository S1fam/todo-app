...
if __name__ == "__main__":  # __name__ == __main__ only when we run functions.py (this) directly. not print in 1.main.py
    print(__name__)  # in 1.main.py if we called print(__name__) of this file (would have to be outside if)
